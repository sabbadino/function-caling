...
public class SetContextBrickWithSql : LangChainBrickBase, ILangChainBrick, ISingletonScope
{
    ...
    private readonly ChatGptSettings _chatGptSettings;
       ...
       public SetContextBrickWithSql(IEmbeddingRepositoryCache embeddingRepositoryCache
    ...
    , GptEncoding gptEncoding, TelemetryClient telemetryClient)
    {
       ...
       public override async Task<Answer> Ask(Question question)
       {
           ...
           try
           {
               ...
               var embeddingSetName = question.EmbeddingSetCode ??
                                      _chatGptSettings.DefaultEmbeddingSetCode;
               var userQuestionEmbeddingsMatch =await  _embeddingRepositoryCache.GetRelevantDocuments(
                   embeddingSetName, await _embeddingServiceCore.GetTextEmbeddings(question.UserQuestion.Text),
                   _chatGptSettings.SimilarityThreshold, maxItems);   
